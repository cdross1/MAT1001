...
The mid point rule is the approximation approach that we met in \cref{sec:integration}  when approximating the area under the curve for the function $f(x)=x^{2}+1$. 
