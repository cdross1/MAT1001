...
\filldraw[black] (9,1.1) circle (1pt) ;
    \end{tikzpicture}
    \caption{A plot of the function which fits the heights from \cref{table:heights} with an approximate polynomial fitted. The polynomial does not quite go through all of the points but passes close to all of them.}
