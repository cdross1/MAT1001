...
\begin{figure}[htbp]
  ...
  %  \includegraphics[width=0.3\textwidth, alt ={A schematic of how a function behaves produced by Bin Im Garten for Wikimedia Commons.}]{figures/Injection_keine_Injektion_2a.png}
     \begin{tikzpicture}[line width=1pt,line cap=round,line join=round, smooth, arrow/.style={thick,->,CDnavy}, set name/.style={font=\color{CDnavy}\Large\bfseries\sf}, set/.style={ultra thick,CDnavy}, every node/.style={circle}]
...
\begin{figure}[ht]
    \centering
    \ThisAltText{plot of both teh positive and negative square roots.}
   % \pdftooltip{
