...
\end{equation}
for $h$ a small step between neighbouring points. This is known as the \textbf{forward difference approximation}, since we are looking at the difference between the function at the point $x$ and at the point $x+h$ one step ahead of $x$. This is shown schematically in \cref{fig: forward difference approximation}.\\
...
\item  $h=0.05$
\begin{equation*}
\frac{\ud f}{\ud x}(2)\simeq \frac{f(2+0.05)-f(2)}{0.1}=\frac{-1.93766+1.66459}{0.1}=-5.46141,
\end{equation*}
\item  $h=0.025$
\begin{equation*}
\frac{\ud f}{\ud x}(2)\simeq \frac{f(2+0.1)-f(2)}{0.1}=\frac{-1.79914+1.66459}{0.1}=-5.38196,
\end{equation*}
 $h=0.0125$
\begin{equation*}
\frac{\ud f}{\ud x}(2)\simeq \frac{f(2+0.1)-f(2)}{0.1}=\frac{-1.73136+1.66459}{0.1}=-5.34196,
\end{equation*}
\end{itemize}
