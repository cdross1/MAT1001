...
There is also lots of extra material in \citep{calcI} including more details on the applications of differentiation, though not the computer science focussed applications.
...
Another book that is relevant to the module is \citep{pagonis2024mathematical}. In particular Chapter 2 is focussed on differentiation and chapter 3 on integration, with both including details on how to implement the numerical methods in python. The level of mathematics in the book is slightly above the level of this module, but it could be a nice companion to the module if you want to see more about how these numerical methods can be used.
