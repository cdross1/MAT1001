...
\CSSFilename{lwarp_sagebrush.css} % This loads a css file that enables us to customise the webpage more. Currently I have not written a css file to be included here.
...
\input{chapters/calculus_in_cs}
\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{chapters/advanced_topics}
\newpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{chapters/maths_appendix}
...
\input{chapters/tutorial_sheets}
...
\input{chapters/standard_identities}
