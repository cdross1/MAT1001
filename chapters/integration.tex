...
Consider the integral 
\begin{equation*}
I=\int_{0}^{\frac{\uppi}{2}}\frac{\sqrt{\sin(x)}}{\sqrt{\sin(x)}+\sqrt{\cos(x)}}\ud x.
\end{equation*}
This may look like an insurmountable integral, but there is a nice substitution trick.  Let $x=\uppi/2 -y$ so that $\ud x=-\ud y$. Note that 
\begin{align*}
\sin\left(\frac{\uppi}{2}-y\right)&=\cos(y)\\
\cos\left(\frac{\uppi}{2}-y\right)&=\sin(y),
\end{align*}
so that 
\begin{align*}
I&=\int_{0}^{\frac{\uppi}{2}}\frac{\sqrt{\sin(x)}}{\sqrt{\sin(x)}+\sqrt{\cos(x)}}\ud x \\
&=\int_{\frac{\uppi}{2}}^{0}\frac{\sqrt{\sin\left(\frac{\uppi}{2}-y\right)}}{\sqrt{\sin\left(\frac{\uppi}{2}-y\right)}+\sqrt{\cos\left(\frac{\uppi}{2}-y\right)}}(-\ud y)\\
&=\int_{0}^{\frac{\uppi}{2}}\frac{\sqrt{\cos(y)}}{\sqrt{\sin(y)}+\sqrt{\cos(y)}}\ud y\\
&=\int_{0}^{\frac{\uppi}{2}}\frac{\sqrt{\cos(x)}}{\sqrt{\sin(x)}+\sqrt{\cos(x)}}\ud x,
\end{align*}
where in the last line we have relabelled $y $ as $x$ since it is the dummy integration variable. Thus
\begin{equation*}
2I=\int_{0}^{\frac{\uppi}{2}}\frac{\sqrt{\sin(x)}+\sqrt{\cos(x)}}{\sqrt{\sin(x)}+\sqrt{\cos(x)}}\ud x=\int_{0}^{\frac{\uppi}{2}}\ud x =\frac{\uppi}{2}.
\end{equation*}
\end{ex}

Another problem that is amenable to a similar trick is in the following exercise.
\begin{exercise}
Use two  substitutions to show that 
\begin{equation*}
I=\int_{0}^{\uppi}\frac{x\sin(x)}{1+\cos^{2}(x)}\ud x=\frac{\uppi^{2}}{4}.
\end{equation*}
\end{exercise}
...
\textcolor{red}{This subsection is currently lacking pictures, these will be added eventually.}\\
